<%-- 
    Document   : detail5
    Created on : May 3, 2016, 11:19:13 PM
    Author     : Rahul
--%>
...
<center>  <img src="<%="upload"+"\\"+cust.getA()%>" width='250px'><br>
          ...
          <tr><td><label>Author:</label></td><td><label>- <%=cust.getH()%></label></td></tr><br>
           <tr><td> <label >Price:</label></td><td><label>- <%=cust.getC()%></label> </td></tr>
           <tr><td> <label >Pages:</label></td><td><label>- <%=cust.getD()%></label> </td></tr>
           <tr><td> <label>Publisher:</label></td><td><label>- <%=cust.getE()%></label> </td></tr>
           <tr><td> <label>Year:</label></td><td><label>- <%=cust.getF()%></label> </td></tr>
           <tr><td> <label>Cover:</label></td><td><label >- <%=cust.getG()%></label> </td></tr>
